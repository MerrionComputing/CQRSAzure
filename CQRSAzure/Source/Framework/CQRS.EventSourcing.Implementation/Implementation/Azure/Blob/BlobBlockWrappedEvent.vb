...
Namespace Azure.Blob
    ...
    Public Class BlobBlockWrappedEvent
        ...
        <DataMember(Name:=NameOf(EventName), Order:=0)>
        ...
        <DataMember(Name:=NameOf(Sequence), Order:=1)>
        ...
        <DataMember(Name:=NameOf(Version), Order:=2)>
        ...
        <DataMember(Name:=NameOf(Timestamp), Order:=3)>
