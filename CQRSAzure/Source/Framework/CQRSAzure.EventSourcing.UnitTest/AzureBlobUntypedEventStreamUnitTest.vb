...
#Region "load the event stream"
        ...
        Task.WaitAll(
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 3"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 4"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "UK", .InternationalDialingCode = "0044"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 125}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 126}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 8"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 9"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "IRL", .InternationalDialingCode = "00353"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "My test", .EventOneIntegerProperty = 223}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 224}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 13"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 14"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "UK", .InternationalDialingCode = "0044"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 225}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 226}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 18"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 19"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "IRL", .InternationalDialingCode = "00353"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "My test", .EventOneIntegerProperty = 323}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 324}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 23"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 24"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "UK", .InternationalDialingCode = "0044"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 325}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 326}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 28"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 29"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "IRL", .InternationalDialingCode = "00353"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "My test", .EventOneIntegerProperty = 423}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 424}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 33"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 34"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "UK", .InternationalDialingCode = "0044"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 425}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 426}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 38"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 39"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "IRL", .InternationalDialingCode = "00353"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "My test", .EventOneIntegerProperty = 523}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 524}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 43"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 44"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "UK", .InternationalDialingCode = "0044"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 525}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 526}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 48"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 49"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "IRL", .InternationalDialingCode = "00353"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "My test", .EventOneIntegerProperty = 623}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 624}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 53"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 54"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "UK", .InternationalDialingCode = "0044"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 625}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 626}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 58"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 59"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "IRL", .InternationalDialingCode = "00353"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "My test", .EventOneIntegerProperty = 723}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 724}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 63"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 64"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "UK", .InternationalDialingCode = "0044"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 725}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A further test", .EventOneIntegerProperty = 726}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 68"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 69"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "IRL", .InternationalDialingCode = "00353"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "My test", .EventOneIntegerProperty = 823}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 824}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 73"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 74"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "UK", .InternationalDialingCode = "0044"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 825}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A further test", .EventOneIntegerProperty = 826}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 78"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 79"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeThree() With {.CountryCode = "IRL", .InternationalDialingCode = "00353"}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "My test", .EventOneIntegerProperty = 923}),
        testWriter.AppendEvent(New Mocking.MockEventTypeOne() With {.EventOneStringProperty = "A test", .EventOneIntegerProperty = 924}),
        testWriter.AppendEvent(New Mocking.MockEventTypeTwo() With {.EventTwoStringProperty = "Test 83"}),
