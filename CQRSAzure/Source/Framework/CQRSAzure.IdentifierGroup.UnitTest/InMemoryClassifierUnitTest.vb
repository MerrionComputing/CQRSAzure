...
<TestClass()> Public Class InMemoryClassifierUnitTest
...
#End Region
    ...
    <TestMethod()>
    Public Sub Write_100Events_ThenClassify_WithSnapshots_Exclude_TestMethod()
...
#End Region
        ...
        'run the 'is even' classifier 
        actual = testProcessorFromSnapshot.Classify(New MockClassifierOddNumber(MY_TEST_KEY))
