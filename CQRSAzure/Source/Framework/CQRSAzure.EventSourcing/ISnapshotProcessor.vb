...
Public Interface ISnapshotProcessorUntyped
    ...
    ''' The projection snapshot to be saved to the backing storage
    ''' </param>
    Sub SaveSnapshot(ByVal snapshotToSave As IProjectionSnapshot)
    ...
    ''' The most recent snapshot available if one has been saved - or Nothing (null) if none exists
    ''' </returns>
    Function GetLatestSnapshot(Optional ByVal priorToSequence As UInteger = 0) As IProjectionSnapshot
