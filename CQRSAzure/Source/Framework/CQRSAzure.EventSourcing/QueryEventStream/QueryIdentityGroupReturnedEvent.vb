...
Namespace Queries
    <Serializable()>
    Public NotInheritable Class QueryIdentityGroupReturnedEvent
        Inherits QueryEventBase
        Implements IQueryIdentityGroupReturnedEvent

        Private ReadOnly m_AsOfDate As Date?
        Public ReadOnly Property AsOfDate As Date? Implements IQueryIdentityGroupReturnedEvent.AsOfDate
            Get
                Return m_AsOfDate
            End Get
        End Property
        ...
        Public ReadOnly Property IdentityGroupName As String Implements IQueryIdentityGroupReturnedEvent.IdentityGroupName
            Get
        ...
        Public Shared Function Create(ByVal AsOfDateIn As Date?,
                 ByVal IdentityGroupNameIn As String) As QueryIdentityGroupReturnedEvent

            Return New QueryIdentityGroupReturnedEvent(AsOfDateIn,
                                                        IdentityGroupNameIn)
        End Function
    End Class
End Namespace
