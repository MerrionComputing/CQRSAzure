...
namespace CQRSAzure.CQRSdsl.Dsl
{
	...
	/// </summary>
	internal abstract partial class CQRSdslDocDataBase
	{
		/// <summary>
		...
		partial void SetValidationExtensionRegistrar(DslValidation::ValidationController validationController)
		{
			if (validationController != null)
			{
				...
				if (compositionService != null)
				{
					...
					validationController.ValidationExtensionRegistrar = new DesignerExtensionEnablement::CQRSdslValidationExtensionRegistrar();
