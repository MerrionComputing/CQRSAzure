...
namespace CQRSAzure.CQRSdsl.Dsl
{
	...
	/// </summary>
	internal partial class CQRSdslCommandSet : CQRSdslCommandSetBase
	{
		/// <summary>
		/// Constructs a new CQRSdslCommandSet.
		/// </summary>
		public CQRSdslCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class CQRSdslCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new CQRSdslCommandSetBase.
		/// </summary>
		protected CQRSdslCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewCQRSdslExplorerCommand,
				typeof(CQRSdslEditorFactory).GUID);
		...
		{
			CQRSdslExplorerToolWindow explorer = this.CQRSdslExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentCQRSdslDocData != null && this.CurrentCQRSdslDocData.Store != null)
			{
				this.CurrentCQRSdslDocData.ValidationController.Validate(this.CurrentCQRSdslDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentCQRSdslDocData != null && this.CurrentCQRSdslDocData.Store != null)
			{
				...
				this.CurrentCQRSdslDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected CQRSdslDocData CurrentCQRSdslDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as CQRSdslDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected CQRSdslDocView CurrentCQRSdslDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as CQRSdslDocView;
			}
		}
		...
		/// </summary>
		protected CQRSdslExplorerToolWindow CQRSdslExplorerToolWindow
		{
			get
			{
				CQRSdslExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(CQRSdslExplorerToolWindow), true) as CQRSdslExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				CQRSdslExplorerToolWindow explorerWindow = this.CQRSdslExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class CQRSdslClipboardCommandSet : CQRSdslClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new CQRSdslClipboardCommandSet.
		/// </summary>
		public CQRSdslClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class CQRSdslClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new CQRSdslClipboardCommandSetBase.
		/// </summary>
		protected CQRSdslClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
