...
namespace CQRSAzure.CQRSdsl.Dsl
{
	...
	/// </remarks>
	public partial class CQRSdslHelpKeywordHelper : CQRSdslHelpKeywordHelperBase 
	{
		private static CQRSdslHelpKeywordHelper helpKeywordHelper;
		
		/// <summary>
		/// Constructs a new CQRSdslHelpKeywordHelper.
		/// </summary>
		protected CQRSdslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the CQRSdslHelpKeywordHelper.
		/// </summary>
		public static CQRSdslHelpKeywordHelper Instance
		{
			get
			{
				if(helpKeywordHelper == null)
				{
					helpKeywordHelper = new CQRSdslHelpKeywordHelper();
				}
	...
	/// </summary>
	public abstract class CQRSdslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new CQRSdslHelpKeywordHelperBase.
		/// </summary>
		protected CQRSdslHelpKeywordHelperBase()
			: base() { }
		...
		{
			this.helpKeywords = new global::System.Collections.Generic.Dictionary<string, string>(4);
			this.helpKeywords.Add(@"CQRSAzure.CQRSdsl.Dsl.EventDefinition", @"Event");
			this.helpKeywords.Add(@"CQRSAzure.CQRSdsl.Dsl.CommandDefinition", @"Command");
			this.helpKeywords.Add(@"CQRSAzure.CQRSdsl.Dsl.AggregateGeometryShape", @"Aggregate");
			this.helpKeywords.Add(@"CQRSAzure.CQRSdsl.Dsl.ProjectionDefinitionCompartmentShape", @"Projection");
		}
